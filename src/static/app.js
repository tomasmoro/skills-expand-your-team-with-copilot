  ...
  function renderActivityCard(name, details) {
    ...
    activityCard.innerHTML = `
      ...
      <div class="share-buttons">
        ...
        <button class="share-button share-twitter" data-activity="${name}" data-description="${details.description}" title="Share on Twitter/X">
        ...
        <button class="share-button share-whatsapp" data-activity="${name}" data-description="${details.description}" title="Share on WhatsApp">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
